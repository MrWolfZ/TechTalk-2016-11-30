...
namespace VolatilityDecomposition.Areas.HelpPage
{
  public static class ApiDescriptionExtensions
  {
    ...
    public static string GetFriendlyId(this ApiDescription description)
    {
      ...
      friendlyPath.Append($"{description.HttpMethod.Method}-{localPath.Replace("/", "-").Replace("{", string.Empty).Replace("}", string.Empty)}");
      if (queryKeyString != null)
      {
        friendlyPath.Append($"_{queryKeyString.Replace('.', '-')}");
      }
